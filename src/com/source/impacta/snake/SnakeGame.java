...
// 14- Nesta classe devemos considerar a criação de uma serie de elementos que trarão ações ao jogo

public class SnakeGame extends JFrame {		
		/**
		 * 1- O UID da versão serial.
		 */
		private static final long serialVersionUID = 6678292058307426314L;

		/**
		 * 2- O número de milissegundos que devem passar entre cada quadro.
		 */
		private static final long FRAME_TIME = 1000L / 50L;
		
		/**
		 * 3-
		 * O comprimento mínimo da cobra. Isso permite que a cobra cresça
		 * bem quando o jogo começa, para que não sejamos apenas uma cabeça em movimento
		...
		/**
		 * 4-
		 * O número máximo de direções que podemos ter pesquisado no
		 * lista de direção.
		 */
		...
		/**
		 * 7-
		 * O gerador de números aleatórios (usado para iniciar as frutas randomicaments).
		 */
		...
		// Estes são os passos que devem ser feitos antes de partirmos para o construtor da classe.
		
		
		/**
		 * Cria uma nova instância SnakeGame. Cria uma nova janela,
		 * e configura a entrada do controlador.
		 */
		private SnakeGame() {
			super("Snake Game - Remastered");
